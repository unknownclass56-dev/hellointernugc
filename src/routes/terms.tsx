...
export const Route = createFileRoute("/terms")({
  component: TermsPage,
  head: () => ({
    meta: [{ title: "Terms & Conditions — UGC INTERN" }, { name: "description", content: "Terms governing your use of UGC INTERN." }],
  ...
  return (
    <PageShell>
      <article className="container mx-auto max-w-3xl px-4 py-16 prose prose-headings:font-display prose-headings:text-navy-deep">
        ...
        <p>By accessing or using UGC INTERN, you agree to be bound by these Terms.</p>
        <h2>Eligibility</h2>
        ...
        <h2>Contact</h2>
        <p><a href="mailto:support@ugcintern.in">support@ugcintern.in</a></p>
      </article>
    </PageShell>
  );
}
