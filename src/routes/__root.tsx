...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "TechLaunchpad — AICTE · UGC · BSDM · ISO Internship Portal" },
      { name: "description", content: "TechLaunchpad is an industry-focused internship and training platform providing AICTE aligned, UGC guided, BSDM supported and ISO certified learning opportunities." },
      { name: "author", content: "TechLaunchpad" },
      { property: "og:site_name", content: "TechLaunchpad" },
      { property: "og:type", content: "website" },
      { property: "og:title", content: "TechLaunchpad — Premium Internship Portal" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          email: "support@techlaunchpad.in",
        }),
      },
    ],
  }),
