...
export const Route = createFileRoute("/about")({
  ...
  head: () => ({
    meta: [
      { title: "About Us — TechLaunchpad" },
      { name: "description", content: "TechLaunchpad's mission is to make industry-aligned internships accessible to every Indian student through AICTE, UGC, BSDM and ISO frameworks." },
      { property: "og:title", content: "About — TechLaunchpad" },
    ...
    <PageShell>
      <section className="bg-gradient-to-b from-navy-deep to-navy py-20 text-ivory">
        <div className="container mx-auto px-4 text-center">
          <div className="mb-3 text-xs font-semibold uppercase tracking-[0.25em] text-gold">About TechLaunchpad</div>
      ...
      <section className="container mx-auto px-4 py-20">
        <SectionHeader eyebrow="Recognitions" title="Aligned with India's leading frameworks" description="TechLaunchpad's programs are designed in alignment with the standards of these national bodies." />
      ...
      <section className="bg-gradient-to-br from-navy-deep to-navy py-20 text-ivory">
        <div className="container mx-auto grid gap-10 px-4 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-4 leading-relaxed text-ivory/80">Founded by a small team of educators and engineers, TechLaunchpad began as a research project documenting the gap between academic learning and industry expectations across Indian universities. Today it serves students from over 800 institutions and partners with 1,200+ companies.</p>
          </div>
